        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="flex items-start justify-between mb-8">
            ...
            <div className="flex items-center gap-2 bg-surface-container-lowest border border-outline-variant rounded-full px-4 py-2 flex-shrink-0">
              ...
              <div className="text-right">
                <div className="text-xs font-mono font-bold text-primary">0x7a...F92</div>
              ...
              <div className="bg-surface-container-lowest border border-outline-variant rounded-2xl p-8 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  {[
                    ...
                    <label
                      key={doc.key}
                      className={`flex flex-col items-center justify-center p-6 rounded-2xl border-2 border-dashed cursor-pointer transition-all text-center ${
                        files[doc.key]
          ...
          {step === 4 && (
            <>
                ...
                <button
                  onClick={() => {
                    mutation.mutate({
                      ...
                      registration_doc_url: files.regCertificate ? URL.createObjectURL(files.regCertificate) : "https://placeholder.aidchain.io/reg.pdf",
                      tax_id_doc_url: files.taxId ? URL.createObjectURL(files.taxId) : "https://placeholder.aidchain.io/tax.pdf",
                      proof_of_operation_url: files.proofOfOperation ? URL.createObjectURL(files.proofOfOperation) : "https://placeholder.aidchain.io/proof.pdf",
                    });
                  }}
              ...
              {mutation.error && (
                <div className="mt-4 bg-error-container border border-error rounded-xl p-4">
